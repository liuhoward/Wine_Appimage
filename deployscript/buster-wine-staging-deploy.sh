...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-staging_4.11~buster_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-staging-i386_4.11~buster_i386.deb

dpkg -x wine-staging_4.11~buster_i386.deb wineversion/
dpkg -x wine-staging-i386_4.11~buster_i386.deb wineversion/
