...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-stable_4.0.2~buster_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-stable-i386_4.0.2~buster_i386.deb

dpkg -x wine-stable_4.0.2~buster_i386.deb wineversion/
dpkg -x wine-stable-i386_4.0.2~buster_i386.deb wineversion/
