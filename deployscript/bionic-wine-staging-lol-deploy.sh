...
wget -nvc https://launchpad.net/~mmtrt/+archive/ubuntu/testing/+files/wine-staging_4.16-3~bionic1_i386.deb -O wine-staging_4.16-lol~bionic_i386.deb
wget -nvc https://launchpad.net/~mmtrt/+archive/ubuntu/testing/+files/wine-staging-i386_4.16-3~bionic1_i386.deb -O wine-staging-i386_4.16-lol~bionic_i386.deb
