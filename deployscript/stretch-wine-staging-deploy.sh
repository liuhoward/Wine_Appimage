...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/stretch/main/binary-i386/wine-staging_4.11~stretch_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/stretch/main/binary-i386/wine-staging-i386_4.11~stretch_i386.deb

dpkg -x wine-staging_4.11~stretch_i386.deb wineversion/
dpkg -x wine-staging-i386_4.11~stretch_i386.deb wineversion/
