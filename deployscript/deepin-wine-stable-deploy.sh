...
# Get Wine
WINE_VERSION=5.0.11-1

wget -nv -c https://community-packages.deepin.com/deepin/pool/main/d/deepin-wine5/deepin-wine5-i386_${WINE_VERSION}_i386.deb
wget -nv -c https://community-packages.deepin.com/deepin/pool/main/d/deepin-wine5/deepin-wine5-tools_${WINE_VERSION}_i386.deb
wget -nv -c https://community-packages.deepin.com/deepin/pool/main/d/deepin-wine5/deepin-wine5_${WINE_VERSION}_i386.deb

wget -nv -c https://community-packages.deepin.com/deepin/pool/non-free/u/udis86/udis86_1.72-2_i386.deb

dpkg -x deepin-wine5-i386_${WINE_VERSION}_i386.deb wineversion/
dpkg -x deepin-wine5-tools_${WINE_VERSION}_i386.deb wineversion/
dpkg -x deepin-wine5_${WINE_VERSION}_i386.deb wineversion/
dpkg -x deepin-wine5_${WINE_VERSION}_i386.deb wineversion/
...
export ARCH=x86_64; squashfs-root/AppRun -v $wineworkdir -u 'gh-releases-zsync|Wine_Appimage|continuous' wine-stable-i386_${ARCH}-deepin.AppImage
